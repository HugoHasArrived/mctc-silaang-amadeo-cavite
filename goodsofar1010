...
.header-inner{width:100%;max-width:1500px;margin:0 auto;padding:11px 16px 13px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:9px}
.brand-area{width:100%;display:flex;align-items:center;justify-content:center}.brand-link{display:flex;align-items:center;justify-content:center;gap:12px;color:#fff;text-align:center}.brand-link:hover{text-decoration:none}
.logo{width:74px;height:74px;object-fit:contain;background:#fff;border-radius:50%;padding:4px;box-shadow:0 4px 18px rgba(0,0,0,.18)}
.brand strong,.brand small{display:block;text-align:center}.brand strong{font-size:15px;line-height:1.2}.brand small{opacity:.9;margin-top:3px}
.nav{width:100%;display:flex;align-items:center;justify-content:center;flex-wrap:wrap;gap:5px}.nav-group{display:flex;align-items:center;justify-content:center;flex-wrap:wrap;gap:4px}
.nav a,.nav button{min-height:38px;display:inline-flex;align-items:center;justify-content:center;padding:8px 10px;border:0;border-radius:10px;background:transparent;color:#fff;font-size:12px;font-weight:800;text-align:center;white-space:nowrap;cursor:pointer}
.nav a:hover,.nav button:hover{background:rgba(255,255,255,.14);color:#fff;text-decoration:none}.nav-form{display:inline-flex;align-items:center;justify-content:center;margin:0}
...
@media(max-width:700px){.header-inner{padding:9px 8px 11px}.brand-link{flex-direction:column}.logo{width:70px;height:70px}.desktop-nav{display:none}.mobile-menu{display:block;width:100%}.mobile-menu summary{list-style:none;display:flex;align-items:center;justify-content:center;min-height:42px;border:1px solid rgba(255,255,255,.2);border-radius:10px;color:#fff;font-weight:900;cursor:pointer;background:rgba(255,255,255,.08)}.mobile-menu summary::-webkit-details-marker{display:none}.mobile-panel{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;padding-top:6px}.mobile-panel>*{width:100%;max-width:500px}.two{grid-template-columns:1fr}}
'''
...
<header class='site-header'><div class='header-inner'><div class='brand-area'><a class='brand-link' href='{url_for('home')}'><img class='logo' src='{logo_url()}' alt='Official court logo'><div class='brand'><strong>{esc(COURT_NAME)}</strong><small>Official Court Information Portal</small></div></a></div><nav class='nav'><div class='desktop-nav'>{nav}</div><details class='mobile-menu'><summary>☰ &nbsp; Menu</summary><div class='mobile-panel'>{mobile}</div></details></nav></div></header><main class='container'>{flashes()}{content}</main><footer><strong>{esc(COURT_NAME)}</strong><p>{esc(COURT_ADDRESS)}</p><p><a href='tel:{esc(COURT_PHONE)}'>{esc(COURT_PHONE)}</a><br><a href='mailto:{esc(COURT_EMAIL)}'>{esc(COURT_EMAIL)}</a></p><p><a href='{MAP_URL}' target='_blank' rel='noopener noreferrer'>🗺️ {tr('open_maps')}</a></p><p>{tr('copyright')}</p></footer></body></html>"""
