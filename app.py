...
.header-inner{width:100%;max-width:1600px;margin:0 auto;padding:10px 18px;display:flex;align-items:center;justify-content:center;gap:12px;min-height:84px}
.header-logo{width:64px;height:64px;object-fit:contain;background:#fff;border-radius:50%;padding:4px;box-shadow:0 4px 18px rgba(0,0,0,.18);flex:0 0 auto}
.header-logo.supreme{width:56px;height:56px;padding:3px}
.center-nav{display:flex;align-items:center;justify-content:center;flex:1 1 auto;min-width:0}
.nav{display:flex;align-items:center;justify-content:center;flex-wrap:wrap;gap:4px;width:100%}.nav-group{display:flex;align-items:center;justify-content:center;flex-wrap:wrap;gap:4px}.nav-logo{width:48px;height:48px;object-fit:contain;background:#fff;border-radius:50%;padding:3px;box-shadow:0 3px 12px rgba(0,0,0,.16);flex:0 0 auto}.nav-logo.supreme{width:44px;height:44px;padding:2px}
.nav a,.nav button{min-height:38px;display:inline-flex;align-items:center;justify-content:center;padding:8px 10px;border:0;border-radius:10px;background:transparent;color:#fff;font-size:12px;font-weight:800;text-align:center;white-space:nowrap;cursor:pointer}.nav a:hover,.nav button:hover{background:rgba(255,255,255,.14);color:#fff;text-decoration:none}.nav-form{display:inline-flex;align-items:center;justify-content:center;margin:0}
...
@media(max-width:700px){.header-inner{padding:8px;min-height:70px}.center-nav{width:100%}.desktop-nav{display:none}.mobile-menu{display:block;width:100%}.nav-logo{width:42px;height:42px}.nav-logo.supreme{width:40px;height:40px}.mobile-menu summary{list-style:none;display:flex;align-items:center;justify-content:center;min-height:42px;border:1px solid rgba(255,255,255,.2);border-radius:10px;color:#fff;font-weight:900;cursor:pointer;background:rgba(255,255,255,.08)}.mobile-menu summary::-webkit-details-marker{display:none}.mobile-panel{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;padding-top:6px}.mobile-panel>*{width:100%;max-width:500px}.two{grid-template-columns:1fr}}
'''
...
def render_page(title, content):
    ...
    if is_staff():
        nav = f"""
        <div class='nav-group'>
        <img class='nav-logo' src='{logo_url()}' alt='MCTC Silang-Amadeo official logo'>
...
<header class='site-header'><div class='header-inner'><div class='center-nav'><nav class='nav'><div class='desktop-nav'>{nav}</div><details class='mobile-menu'><summary>☰ &nbsp; Menu</summary><div class='mobile-panel'>{mobile}</div></details></nav></div></div></header><main class='container'>{flashes()}{content}</main><footer><strong>{esc(COURT_NAME)}</strong><p>{esc(COURT_ADDRESS)}</p><p><a href='tel:{esc(COURT_PHONE)}'>{esc(COURT_PHONE)}</a><br><a href='mailto:{esc(COURT_EMAIL)}'>{esc(COURT_EMAIL)}</a></p><p><a href='{MAP_URL}' target='_blank' rel='noopener noreferrer'>🗺️ {tr('open_maps')}</a></p><p>{tr('copyright')}</p></footer></body></html>"""
